...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12">
            ...
            <input type="hidden" id="id_kategori_show" value="{{ $kategori->id }}">
            <div class="grid-spr">
                <div class="row">
                    <h2 class="">{{ $kategori->nama_kategori }}</h2>
                    <span class=""> {{ $kategori->deskripsi }}</span>
                    <br>
                    <br>
                    <hr>
                    <br>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            var id = $('#id_kategori_show').val()
            let currentPage = 1;
            getProduct(currentPage, id)
            ...
            $('#sortProducts').on('change', function() {
                ...
                getProduct(currentPage, id); // Panggil ulang untuk produk baru
            });
        ...
        function getProduct(page, id) {
            ...
            // $('#no-more-assets').hide();
            $.ajax({
                url: BASE_URL + '/get-product-category/' + id + '?page=' + page, // URL dengan parameter halaman
                ...
                success: function(response) {
                    ...
                    if (data.length > 0) {
                        ...
                        <small class="mt-5 "> ${item.nama_umkm}</small>
                        <br>
                        <br>
